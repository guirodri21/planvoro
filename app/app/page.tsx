    ...
    <div className="dashboard-shell">
      ...
      {!data && loading ? (
        ...
        <div className="dashboard-stack">
          ...
          <DeleteAccountCard accessToken={session?.access_token ?? null} />
        </div>
      )}
    </div>
  );
 ...
 *
 * A confirmacao por digitacao existe porque a acao e irreversivel e apaga
 * as viagens que a pessoa organiza para todo o grupo.
 */
function DeleteAccountCard({ accessToken }: { accessToken: string | null }) {
  ...
  async function deleteAccount() {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Erro ao apagar a conta.");
      setWorking(false);
    }
  }
        ...
        <div className="danger-confirm">
          ...
          <div className="danger-actions">
            ...
            <button
              ...
              disabled={working || confirm.trim().toUpperCase() !== "APAGAR"}
            >
              {working ? "Apagando..." : "Apagar definitivamente"}
            </button>
          </div>
        </div>
      )}
