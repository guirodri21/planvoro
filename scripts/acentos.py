...
DICIONARIO = {
    ...
    "exportacao": "exportação", "geracao": "geração", "Geracao": "Geração",
    "geracoes": "gerações", "presenca": "presença", "Presenca": "Presença",
    "alguem": "alguém", "Alguem": "Alguém",
    "porem": "porém", "tambem": "também",
    "ate": "até", "apos": "após", "Apos": "Após",
